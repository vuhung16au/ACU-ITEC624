...
This script implements the Vigenère cipher for encrypting and decrypting messages.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Vigenère Cipher - Encrypt or decrypt text using the Vigenère cipher'
    )
    ...
    parser.add_argument(
        '--encrypt',
        action='store_true',
        help='Encrypt the input text (default is decrypt)'
    )
